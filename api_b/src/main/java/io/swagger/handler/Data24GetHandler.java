...
import io.undertow.server.HttpServerExchange;
    ...
    public class Data24GetHandler implements HttpHandler {

        static String HANDLER_NUMBER = "24";
        ...
        public void handleRequest(HttpServerExchange exchange) throws Exception {
            ...
            try {
                ...
                HttpGet httpGet = new HttpGet(apidUrl+"?apiKey="+parameter.getFirst());                CloseableHttpResponse response = client.execute(httpGet);
